...
//double FiO2; // Must be greater than room air oxygen concentration 0.21
...
//int outO2; // O2 sensor in exhalation

// Outer circuit variables
//int O2Pressure; // Pressure sensor in outer circuit O2 tube
//int airPressure; // Pressure sensor in outer circuit air tube
 ...
 */
//void loop_control_outer(100) { // 10 Hz
//  // (Air Flow)/(Oxygen Flow) = (1 - FiO2)/(FiO2 - 0.21)
//  double airValvePercentOpen;
//  double O2ValvePercentOpen;
